# Global
account_environment = "cm-dev-qa" # pc-poc, cm-dev, cm-qa, cm-prod
environment = "DEV" # POC, DEV, QA, PROD
vf_region = "emea"
magento_environment = "qa"

# Terraform state
bucket = "vf-cm-dev-infrastructure-code"
key = "terraform-state/infrastructure/magento/cm-dev-qa/terraform.tfstate"
region = "eu-west-1"
...
dickies_config = {
  ...
  external_load_balancer_domain = "qa.dickieslife.com"
  external_load_balancer_alt_domain = ""
  internal_load_balancer_domain = "dickieslife-qa.mage.cm-dev-emea.vfc-int.com"
  ...
  rds_cluster_instance_snapshot = "arn:aws:rds:eu-west-1:018795316058:snapshot:qa-dk-migrate-to-aurora"
  is_enabled = true
...
kipling_config = {
  ...
  create_bucket_prices = true
  create_bucket_stock = true
  external_load_balancer_domain = "qa-m2.kipling.com"
  external_load_balancer_alt_domain = ""
  internal_load_balancer_domain = "kipling-qa.mage.cm-dev-emea.vfc-int.com"
  cache_type = "cache.t3.micro"
  elastic_instance_type = "t2.small.elasticsearch"
  elastic_number_instances = 2
  elastic_volume_size = 20
  ...
  rds_cluster_instance_number = 1
  rds_cluster_instance_class = "db.t3.medium"
  rds_cluster_instance_snapshot = "arn:aws:rds:eu-west-1:018795316058:snapshot:qa-kp-migrate-to-autora"
  is_enabled = true
  is_opened_to_internet = false
}
...
eastpak_config = {
  ...
  create_bucket_prices = true
  create_bucket_stock = true
  external_load_balancer_domain = "qa-m2.eastpak.com"
  external_load_balancer_alt_domain = ""
  internal_load_balancer_domain = "eastpak-qa.mage.cm-dev-emea.vfc-int.com"
  cache_type = "cache.t3.micro"
  elastic_instance_type = "t2.small.elasticsearch"
  elastic_number_instances = 2
  elastic_volume_size = 20
  elastic_subnet = "subnet-0cb26c3d6b09cbe44"
  is_elastic_instances_created = true
  ...
  rds_cluster_instance_number = 1
  rds_cluster_instance_class = "db.t3.medium"
  rds_cluster_instance_snapshot = "arn:aws:rds:eu-west-1:018795316058:snapshot:qa-ep-migrate-to-aurora"
  is_enabled = true
  is_opened_to_internet = false
}
